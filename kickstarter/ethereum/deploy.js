...
const compiledFactoryJSON = require('./build/CampaignFactory.json');
...
const deploy = async () => {
    ...
    const result = await new web3.eth.Contract(JSON.parse(compiledFactoryJSON.interface))
    .deploy({data: compiledFactoryJSON.bytecode})
